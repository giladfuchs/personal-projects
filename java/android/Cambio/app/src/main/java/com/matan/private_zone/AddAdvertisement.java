...
public class AddAdvertisement extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add=(Button) findViewById(R.id.addAdverBtn);
        /*
        ...
        */
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(AddAdvertisement.this,LoadingPrivateZone.class);
    ...
    private void addNotification(String channel)
    {
        ...
        Notification notification = notificationBuilder
                ...
                .setContentText("User added a new advertisement in "+channel)
